...
clean() {
    rm -rf ssl RabbitMQ/certs Redis/certs Influxdb/certs Grafana/certs Sensu/certs
}
...
setup_folders() {
  mkdir -p RabbitMQ/certs Redis/certs Influxdb/certs Grafana/certs Sensu/certs
